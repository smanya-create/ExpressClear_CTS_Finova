...
public class InwardBatchDAOImpl implements InwardBatchDAO {
	...
	public List<InwardBatch> getBatchesForMicrRepair() {
		...
		String sql = "SELECT ib.inward_batch_id, " + "ib.batch_reference_id, " + "ib.actual_cheque_count, "
				...
				+ "     'SEND_BACK_TO_MAKER_MICR', " + "     'MICR_REPAIR_COMPLETED') " + ") "
	...
	public List<InwardReportChequeDTO> getChequesByBatch() {
		...
		String sql = "SELECT " + "ic.inward_cheque_id, ic.inward_batch_id, " + "ic.cheque_number, ic.micr_code, "
				...
				+ "ic.cheque_amount, " + "ic.cheque_date, " + "ic.cheque_status, "
				...
				+ "ON drawee_bank.bank_code = drawee_branch.bank_code " + "LEFT JOIN master_account payee_acc "
