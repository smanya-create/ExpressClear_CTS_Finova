...
public class OutwardMakerDAOImpl implements OutwardMakerDAO {
    ...
    public List<MicrRepairChequeDTO> getScanMicrRepairCheques(
        ...
        String sql =
              ...
              + "FROM scan_cheque sc "
              + "LEFT JOIN outward_cheque_request ocr "
              + "ON ocr.cheque_id = sc.scanned_cheque_id "
              + "AND UPPER(TRIM(sc.cheque_status)) = "
              + "'MICR_REJECTED' "
    ...
    public void saveScanMicrRepair(
        ...
        String updateRequestSql =
                "UPDATE outward_cheque_request SET "
              + "batch_id = ?, "
              + "remarks = ?, "
              + "reason_id = ?, "
              + "reason = ? "
        ...
        try (Connection connection =
            ...
            try {
                ...
                /*
                 * Rejection request is saved only when
                ...
                if ("MICR_REJECTED".equalsIgnoreCase(
                    ...
                    if (requestExists) {
                        ...
                        try (PreparedStatement statement =
                            ...
                            statement.setString(
                                    3, cheque.getReasonId());

                            statement.setString(
                                    4, cheque.getReason());

                            statement.setString(
                                    5, cheque.getChequeId());
    ...
    public List<MicrRepairChequeDTO>
        ...
        String sql =
              ...
              + "LEFT JOIN outward_cheque_request ocr "
              + "ON ocr.cheque_id = oc.outward_cheque_id "
