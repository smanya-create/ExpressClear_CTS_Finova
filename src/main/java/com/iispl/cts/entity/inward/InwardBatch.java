...
public class InwardBatch implements Serializable {
	...
	private int micrRepairPendingCount;

	public InwardBatch() {
	}

	public InwardBatch(String inwardBatchId, String batchReferenceId, int actualChequeCount,
			BigDecimal actualTotalAmount, String batchStatus, String uploadedBy, Timestamp uploadedAt) {
	...
	public int getMicrRepairPendingCount() {
		return micrRepairPendingCount;
	}

	public void setMicrRepairPendingCount(int micrRepairPendingCount) {
		this.micrRepairPendingCount = micrRepairPendingCount;
	}
