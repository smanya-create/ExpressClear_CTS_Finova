...
public class OutwardRejectedCheques implements Serializable {
	...
	public OutwardRejectedCheques(String outwardRejectedChequeId, String outwardChequeId, String chequeNumber,
			String rejectedBy, Timestamp rejectedDate, String remarks, String outwardBatchId, BigDecimal chequeAmount,
			String rejectedReasonId, String rejectedReasonName) {
	...
	public String getOutwardRejectedChequeId() {
		return outwardRejectedChequeId;
	}

	public void setOutwardRejectedChequeId(String outwardRejectedChequeId) {
		this.outwardRejectedChequeId = outwardRejectedChequeId;
	}
