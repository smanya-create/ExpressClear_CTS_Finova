	...
	private void updateDisplayedImage(InwardCheque item) {
		...
		if (rawPath != null && !rawPath.trim().isEmpty()) {
			...
			if (is != null) {
				...
				String diskPath = "/home/iispl/snap/eclipse/common/git/ExpressClear_CTS_Finova/src/main/resources/"
						+ resourcePath;
				...
				if (file.exists()) {
					...
					System.err.println(
							"ERROR: Image could not be located anywhere for cheque: " + item.getChequeNumber());
